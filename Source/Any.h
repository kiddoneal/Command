...
#error "Any SOO can only be enabled with C++11 support"
	...
	union Placeholder
		/// ValueHolder union (used by Poco::Any and Poco::Dynam::Var for small
	...
	private:
		...
		friend class Any;
		friend class Dynam::Var;
		friend class Dynam::VarHolder;
		template <class> friend class Dynam::VarHolderImpl;
	};
